...
• Need CSV import files? Use the AdGenius web app on your computer
...
export async function exportProductKit(
  ...
  for (const v of completed) {
    ...
    zip.file(`images/${name}.jpg`, extractBase64(v.imageUrl!), { base64: true });
  }
  ...
  // Write to cache
  const fileName = `adgenius-${platform}-${Date.now()}.zip`;
